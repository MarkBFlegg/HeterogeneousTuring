...
while is<msteps;    % ********************** continuation loop ****************************
   ...
   while stepok==0     % loop to find next point
      ...
      ntime=tic; 
      %fprintf('entering Newton iterations\n');
      ...
      %fprintf('finished Newton iterations\n');
   ...
   p.sol.restart=0; p.sw.abs=0; p.u=u1; p.tau=tau1;     % step accepted! 
